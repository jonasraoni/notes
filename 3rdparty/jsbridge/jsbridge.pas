...
{$M+}
  ...
  public
    ...
    function GetProperty(AName: TBridgeString): jsval;
    function SetProperty(AName, AValue: TBridgeString): JSBool;
  end;
{$M-}
...
function TJSBridge.GetProperty(AName: TBridgeString): jsval;
var
  ts: TBridgeString;
  PInfo: PPropInfo;
  obj: PJSObject;
...
begin
  ...
  begin
    ...
    begin
      ...
      JS_SetPrivate(_FJSObject, obj, pMethodEntry^.addr);
      _FMethods[str] := obj;
...
function TJSBridge.SetProperty(AName, AValue: TBridgeString): JSBool;
var
  PInfo: PPropInfo;
begin
  PInfo := GetPropInfo(self.ClassInfo, AName);
