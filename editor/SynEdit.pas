...
$Id: SynEdit.pas,v 1.3 2004/07/17 03:44:11 andersonrb Exp $
...
{$ENDIF}
    ...
    //fWordWrapGlyph: TSynGlyph; NOTES --> PARA QUE ÍCONE?????!!?!?!
...
{$ENDIF}
    ...
    //procedure SetWordWrapGlyph(const Value: TSynGlyph); NOTES
...
{$ENDIF}
  ...
  public
    ...
    // property WordWrapGlyph: TSynGlyph read fWordWrapGlyph write SetWordWrapGlyph; NOTES
    property OnChange: TNotifyEvent read FOnChange write FOnChange;
...
// fRightEdge has to be set before FontChanged is called for the first time
  ...
  //fWordWrapGlyph := nil; NOTES
  // TSynGlyph.Create(HINSTANCE, 'SynEditWrapped', clLime);
